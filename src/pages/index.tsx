...
import { House, PlusCircle, CheckCircle , FilmSlate, Gear, SignOut} from "phosphor-react";

export default function Home() {
  return (
    <div className="flex h-full font-lato">
      <aside className="w-64 bg-blue-800 px-8 py-12">
        <div>
        ...
        <div>
          <ul className="flex flex-col gap-3 text-lg font-normal mb-12 mt-12">
            ...
            <li><a className="flex items-center gap-3" href=""><House size={24}/> Home</a></li>
            <li><a className="flex items-center gap-3" href=""><PlusCircle size={24}/> Sua lista</a></li>
            <li><a className="flex items-center gap-3" href=""><CheckCircle size={24}/> Assistidos</a></li>
            <li><a className="flex items-center gap-3" href=""><FilmSlate size={24}/> Cinemas</a></li>
          </ul>
        </div>
        <div>
          <ul className="flex flex-col gap-3 text-lg font-normal mb-12" >
      ...
      <div className="w-64 bg-blue-800">
